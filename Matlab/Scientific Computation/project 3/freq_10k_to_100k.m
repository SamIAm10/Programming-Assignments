...
xlabel('Real')
ylabel('Imaginary')
title('All solutions for f = [10kHz, 100kHz] and r = 10000m')
legend('Exact solutions', 'Trapezoid solutions', 'Ruffa solutions')
hold off

figure
hold on
plot(10e3:2e3:100e3, abs(trapezoid_solns-exact_solns), '--x', 'MarkerSize', 10)
plot(10e3:2e3:100e3, abs(ruffa_solns-exact_solns), '--x', 'MarkerSize', 10)
xlabel('f (kHz)')
ylabel('Absolute error')
title('Absolute error analysis for f = [10kHz, 100kHz] and r = 10000m')
